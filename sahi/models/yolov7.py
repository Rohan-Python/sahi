...
class Yolov7DetectionModel(DetectionModel):
    def check_dependencies(self) -> None:
        check_requirements(["torch", "yolov7"])
    ...
    def set_model(self, model: Any):
        ...
        if model.__class__.__module__ not in ["yolov7.models.common", "models.common"]:
    ...
    def has_mask(self):
        ...
        if version.parse(yolov7.__version__) < version.parse("6.2.0"):
            return False
        else:
    ...
    def category_names(self):
        if check_package_minimum_version("yolov7", "6.2.0"):
